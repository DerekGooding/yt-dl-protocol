...
public partial class ConfigurationForm : Form
{
    ...
    private void RegisterButton_Click(object sender, EventArgs e) => HandleProtocolRegistering(true);

    private void UnregisterButton_Click(object sender, EventArgs e) => HandleProtocolRegistering(false);
    ...
    private void Guide_Button_Click(object sender, EventArgs e) => new BookmarkForm().ShowDialog();
