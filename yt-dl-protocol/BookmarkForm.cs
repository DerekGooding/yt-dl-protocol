...
public partial class BookmarkForm : Form
{
    ...
    private void Document_MouseDown(object sender, HtmlElementEventArgs e) => e.ReturnValue = false;
    ...
    private void richTextBox1_TextChanged(object sender, EventArgs e) => ApplySyntaxHighlighting();

    private void BookmarkletRichTextBox_MouseDown(object sender, MouseEventArgs e) => BookmarkletRichTextBox.SelectAll();

    private void BookmarkletRichTextBox_KeyPress(object sender, KeyPressEventArgs e) => e.Handled = true;

    private void BookmarkletRichTextBox_MouseLeave(object sender, EventArgs e) => BookmarkletRichTextBox.DeselectAll();

    private void CopyToolStripMenuItem_Click(object sender, EventArgs e) => Clipboard.SetText(jsCode);
}
